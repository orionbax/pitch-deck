...
def download_pdf():
    ...
    language = project['state']['current_language']
    print('the language is: ', language)
    original_slides = project['state']['slides']
    ...
    selected_language = project['state']['current_language']
...
def sort_slides(slides, selected_language):    
    ...
    for slide_name in all_slides:
        for name, _ in slides.items():
            if name.lower() == slide_name.lower():
